as_esri_featureset <- function(x, crs = NULL, call = rlang::caller_env()) {
  # class check
  valid_sfg_classes <- c(
    "sf",
    "data.frame",
  ...
  switch(x_class,
    "sf" = as_esri_featureset_sf(x, crs, call = call),
    "data.frame" = as_esri_featureset_sf(x, crs, call = call),
    "sfc" = as_esri_featureset_sfc(x, crs, call = call)
  )
}
...
as_esri_featureset_sfc <- function(x, crs = NULL, call = rlang::caller_env()) {
  ...
  if (three_dim) {
    switch(sfc_class,
      "sfc_POINT" = sfc_point_featureset_3d(x, sr),
      "sfc_MULTIPOINT" = sfc_multipoint_featureset_3d(x, sr),
      "sfc_LINESTRING" = sfc_linestring_featureset_3d(x, sr),
      "sfc_MULTILINESTRING" = sfc_multilinestring_featureset_3d(x, sr),
      "sfc_POLYGON" = sfc_polygon_featureset_3d(x, sr),
      "sfc_MULTIPOLYGON" = sfc_multipolygon_featureset_3d(x, sr),
    )
  } else {
    switch(sfc_class,
      "sfc_POINT" = sfc_point_featureset_2d(x, sr),
      "sfc_MULTIPOINT" = sfc_multipoint_featureset_2d(x, sr),
      "sfc_LINESTRING" = sfc_linestring_featureset_2d(x, sr),
      "sfc_MULTILINESTRING" = sfc_multilinestring_featureset_2d(x, sr),
      "sfc_POLYGON" = sfc_polygon_featureset_2d(x, sr),
      "sfc_MULTIPOLYGON" = sfc_multipolygon_featureset_2d(x, sr),
    )
  }
}
...
as_esri_featureset_sf <- function(x, crs = NULL, call = rlang::caller_env()) {
  ...
  arcgisutils:::check_data_frame(x)
  ...
  bad_types <- lapply(.data[, invalid_types], arcgisutils:::obj_type_friendly)
  ...
  if (three_dim) {
    as_featureset_3d(.data, .geoms, nrow(.data), sr)
  } else {
    as_featureset_2d(.data, .geoms, nrow(.data), sr)
  }
}
